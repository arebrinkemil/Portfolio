...
const Contact = () => {
  return (
    <div id="contact" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
      ...
      <form
        action="https://getform.io/f/PdRZ9qdG"
        method="post"
      ...
      >
        <div className="grid md:grid-cols-2 gap-4 w-full py-2">
          <div className="flex flex-col">
            ...
            <input
              className="bg-darkmode text-white border-2 rounded-lg p-3 flex border-gray-300"
              type="text"
              name="name"
            />
          </div>
        ...
        <div className="flex flex-col py-2">
          ...
          <textarea
            className="bg-darkmode text-white border-2 rounded-lg p-3 border-gray-300"
            rows="10"
            name="message"
          ></textarea>
        </div>
